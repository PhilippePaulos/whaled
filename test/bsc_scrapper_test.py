...
from scrapping.bsc_scrapper import BscScanScrapper


class BscScanScrapperTest(TestCase):

    @patch('scrapping.bsc_scrapper.BscScanScrapper.get_trades_url')
    def test_scrap(self, mock_get_trades_url):
        ...
        self.assertTrue(
            trades_list[0] == TokenTrade(txn_hash='0xa0ec390af06c29592d1d776fd2e3f954a69801aa55b735a59cfafa73fcac47bd',
                                         action=Action.BUY, amount_in='535664.913904223 SHIB',
                                         amount_out='0.0555153483551779 WBNB',
                                         value=Decimal('0'))
        )
